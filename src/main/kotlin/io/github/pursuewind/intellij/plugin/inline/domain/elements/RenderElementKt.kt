...
import io.github.pursuewind.intellij.plugin.inline.domain.MyTextAttributes
...
import io.github.pursuewind.intellij.plugin.inline.domain.wrapper.RangeHighlighterAdapter
...
interface RenderElementKt {
    ...
    class RustStyleText(
        ...
        override fun toString(): String =
            "RustStyle-text { offset:$offset, fromLineStart:${offset - lineStartOffset}, effects:$effects }"
    }
}